...
class DocumentIngestion:
    ...
    """
    def __init__(self, base_dir: str = "dummy_data/document_compare", session_id=None):
        ...
        self.log.info(f"Document Comparator Initialized",session_path=str(self.session_path))
    ...
    def save_uploaded_files(self, reference_file, actual_file):
        ...
        try:
            ...
            if not reference_file.name.lower().endswith(".pdf") or actual_file.name.lower().endswith(".pdf"):
    ...
    def read_pdf(self, pdf_path: Path) -> str:
      ...
      def combine_documents(self) -> str:
            """
            Combine content of all PDFs in a session folder into a single string
            """
            try:
                  doc_parts = []
                  ...
                  self.log.error("Error combining docs", error = str(e), session=self.session_id)
                  raise DocumentPortalException("Error combining docs", sys)
